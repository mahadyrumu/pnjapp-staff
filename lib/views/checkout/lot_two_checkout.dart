...
class LotTwoCheckOut extends StatefulWidget {
  const LotTwoCheckOut({Key? key}) : super(key: key);

  @override
  State<LotTwoCheckOut> createState() => _LotTwoCheckOutState();
}

class _LotTwoCheckOutState extends State<LotTwoCheckOut>
    with AutomaticKeepAliveClientMixin<LotTwoCheckOut> {
  ...
  void _getDropoffs() async {
    ...
    await PickupService().getPickupAllLotTwo().then((res) {
      if (res != null) {
