...
class P2TablePickup extends StatefulWidget {
  const P2TablePickup({Key? key}) : super(key: key);

  @override
  State<P2TablePickup> createState() => _P2TablePickupState();
}

class _P2TablePickupState extends State<P2TablePickup>
    with AutomaticKeepAliveClientMixin<P2TablePickup> {
