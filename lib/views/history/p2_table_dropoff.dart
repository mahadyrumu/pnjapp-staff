...
class P2TableDropoff extends StatefulWidget {
  const P2TableDropoff({Key? key}) : super(key: key);

  @override
  State<P2TableDropoff> createState() => _P2TableDropoffState();
}

class _P2TableDropoffState extends State<P2TableDropoff>
    with AutomaticKeepAliveClientMixin<P2TableDropoff> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      _channel = SupabaseService()
          .liveUpdate(['LOT_2_HISTORY_UPDATE'], getP1TableData);
    });
  }
