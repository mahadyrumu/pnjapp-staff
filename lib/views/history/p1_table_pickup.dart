...
class P1TablePickup extends StatefulWidget {
  const P1TablePickup({Key? key}) : super(key: key);

  @override
  State<P1TablePickup> createState() => _P1TablePickupState();
}

class _P1TablePickupState extends State<P1TablePickup>
    with AutomaticKeepAliveClientMixin<P1TablePickup> {
