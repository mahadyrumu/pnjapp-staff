...
class LotTwoPickup extends StatefulWidget {
  const LotTwoPickup({Key? key}) : super(key: key);

  @override
  State<LotTwoPickup> createState() => _LotTwoPickupState();
}

class _LotTwoPickupState extends State<LotTwoPickup>
    with AutomaticKeepAliveClientMixin<LotTwoPickup> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      _getPickups();
      _channel =
          SupabaseService().liveUpdate(['LOT_2_DISPATCH_UPDATE'], _getPickups);
    });
  }
